...
recession_probit <- glm(NBER_recession_next ~., family = binomial(link = "probit"), data = econ_situation_nber_df2)
...
```{r random_forest, fig.height=8, fig.width=8}
